...
//  iNotes
//
//  Created by Matthew Prockup on 2/4/14.
//
//  This class performs some simple tasks to check network connections. (Probobly should be folded into DeviceProperties at some point)
